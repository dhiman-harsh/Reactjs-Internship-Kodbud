    ...
    return (
        <form action="#" method="GET" className="hidden lg:block lg:pl-2">
            ...
            <div className="relative mt-1 lg:w-96">
                ...
                <input type="text" name="email" id="topbar-search" className="border border-divider text-primary-text sm:text-sm rounded-lg block w-full pl-9 p-2.5 bg-input bg:dark-input" placeholder="Search" />
            </div>
        </form>
    )
}
